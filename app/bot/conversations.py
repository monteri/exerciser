    ...
    return {
        "blocks": [
            ...
            },
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": "Ми раді тебе запросити взяти участь у *Weekly Challenge* :tada:! Тут ти зможеш вирішувати цікаві завдання :jigsaw:, практикуватися в нових технологіях :gear: або покращити свої поточні навички :hammer_and_wrench:. Завдання чекають на тебе!",
                }
            },
            {
                "type": "section",
